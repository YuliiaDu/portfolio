        ...
        <div className="max-w-6xl mx-auto px-6 md:px-10">
          ...
          <div className="grid gap-10 xl:grid-cols-[1.2fr_auto] xl:items-start">
            <div>
              ...
              <div className="mt-8 rounded-3xl border border-mist/80 p-6">
                <div className="grid gap-6 sm:grid-cols-2">
                  <div>
                    <p className="text-label uppercase tracking-[0.18em] text-[#ff4d00] mb-2 block">Client</p>
                    <p className="text-body-sm text-ink font-medium">{project.client ?? "—"}</p>
                  </div>
                  <div>
                    <p className="text-label uppercase tracking-[0.18em] text-[#ff4d00] mb-2 block">Role</p>
                    <p className="text-body-sm text-ink font-medium">{project.role ?? "—"}</p>
                  </div>
                  <div>
                    <p className="text-label uppercase tracking-[0.18em] text-[#ff4d00] mb-2 block">Services</p>
                    <p className="text-body-sm text-ink font-medium">{project.services ?? "—"}</p>
                  </div>
                  <div>
                    <p className="text-label uppercase tracking-[0.18em] text-[#ff4d00] mb-2 block">Year</p>
                    <p className="text-body-sm text-ink font-medium">{project.year}</p>
                  </div>
                </div>
              </div>
            </div>
